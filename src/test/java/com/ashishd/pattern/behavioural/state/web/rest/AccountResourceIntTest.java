package com.ashishd.pattern.behavioural.state.web.rest;

import com.ashishd.pattern.behavioural.state.StatedesignpatternApp;
import com.ashishd.pattern.behavioural.state.config.Constants;
import com.ashishd.pattern.behavioural.state.domain.Authority;
import com.ashishd.pattern.behavioural.state.domain.PersistentToken;
import com.ashishd.pattern.behavioural.state.domain.User;
import com.ashishd.pattern.behavioural.state.repository.AuthorityRepository;
import com.ashishd.pattern.behavioural.state.repository.PersistentTokenRepository;
import com.ashishd.pattern.behavioural.state.repository.UserRepository;
import com.ashishd.pattern.behavioural.state.security.AuthoritiesConstants;
import com.ashishd.pattern.behavioural.state.service.MailService;
import com.ashishd.pattern.behavioural.state.service.UserService;
import com.ashishd.pattern.behavioural.state.service.dto.PasswordChangeDTO;
import com.ashishd.pattern.behavioural.state.service.dto.UserDTO;
import com.ashishd.pattern.behavioural.state.web.rest.errors.ExceptionTranslator;
import com.ashishd.pattern.behavioural.state.web.rest.vm.KeyAndPasswordVM;
import com.ashishd.pattern.behavioural.state.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = StatedesignpatternApp.class)
